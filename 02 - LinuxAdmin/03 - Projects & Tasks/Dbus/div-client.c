...
const char *const CLIENT_BUS_NAME = "in.softprayog.div_client";
const char *const SERVER_OBJECT_PATH_NAME = "/in/softprayog/diver";
const char *const CLIENT_OBJECT_PATH_NAME = "/in/softprayog/div_client";
