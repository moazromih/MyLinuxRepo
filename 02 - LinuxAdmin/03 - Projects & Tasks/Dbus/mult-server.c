...
const char *const SERVER_BUS_NAME = "in.softprayog.mult_server";
const char *const SERVER_BUS_NAME_SUB = "in.softprayog.mult_server";
const char *const OBJECT_PATH_NAME = "/in/softprayog/multer";
const char *const OBJECT_PATH_NAME_SUB = "/in/softprayog/diver";
const char *const METHOD_NAME = "mult_numbers";
const char *const METHOD_NAME_DIV = "div_numbers";
...
//Gets arguments from a message given a variable argument list.
        ...
        else if(dbus_message_is_method_call (message, INTERFACE_NAME, METHOD_NAME_DIV))
        {
            char *s;
            char *str1 = NULL, *str2 = NULL;
            const char space [4] = " \n\t";
