...
const char *const SERVER_BUS_NAME_SUB = "in.softprayog.add_server";
const char *const OBJECT_PATH_NAME = "/in/softprayog/adder";
const char *const OBJECT_PATH_NAME_SUB = "/in/softprayog/subber";
const char *const METHOD_NAME = "add_numbers";
const char *const METHOD_NAME_SUB = "sub_numbers";
...
//Gets arguments from a message given a variable argument list.
        ...
        else if(dbus_message_is_method_call (message, INTERFACE_NAME, METHOD_NAME_SUB))
        {
            char *s;
            char *str1 = NULL, *str2 = NULL;
            const char space [4] = " \n\t";
